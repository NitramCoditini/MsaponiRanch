...
public class CurrentConditionDetail {
    ...
    public CurrentConditionDetail() {
    }

    public CurrentConditionDetail(String ranchHandName, String cowname1, String cowtemperature, String cowappetite, String cowappearance) {
